...
$sql="insert into tblstudent(StudentName,StudentEmail,Gender,DOB,Address,UserName,Password,Image)values(:stuname,:stuemail,:gender,:dob,:address,:uname,:password,:image)";
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1">User Photo</label>
