...
?>
                          <span class="report-title">Deposits</span>
                          <h4><?php echo htmlentities($totclass);?></h4>
                          <a href="deposits.php"><span class="report-count"> View Deposits</span></a>
                        </div>
...
?>
                          <span class="report-title">All Users</span>
                          <h4><?php echo htmlentities($totstu);?></h4>
                          <a href="manage-students.php"><span class="report-count"> View Users</span></a>
                        </div>
...
?>
                          ...
                          <a href="between-dates-reports.php"><span class="report-count"> View Report</span></a>
                        </div>
